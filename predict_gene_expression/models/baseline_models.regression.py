...
for tissue in ['lung']:    
    ...
    elastic_net_model.fit(train_array, train_target)

    # Predict on training and testing sets
    train_preds = elastic_net_model.predict(train_array)
    test_preds = elastic_net_model.predict(test_array)
...
#     model_save_dir = "/well/ludwig/users/dyp502/tissue_atlas_v3/predict_ge/1kb_model/saved_models/"
...
# results_df.to_csv(save_dir + model_name + 'tissue_results.csv', sep='\t')



# with open(save_dir + model_name + "predictions_dict.pkl", "wb") as f:
#     pickle.dump(predictions_dict, f)


# all_tissue_predictions_df.to_csv(save_dir + model_name + "model_predictions_df.csv")
